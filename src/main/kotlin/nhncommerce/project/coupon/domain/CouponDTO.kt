...
data class CouponDTO (
    ...
    fun toEntity(couponDTO: CouponDTO,user : User, expired : LocalDate): Coupon{
        var coupon = Coupon(couponName = couponDTO.couponName, discountRate = couponDTO.discountRate,
